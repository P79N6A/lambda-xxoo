...
public class CfComponent extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.cmptIdColoured) {jsonObj.put("cmptId", this.cmptId);}
        if(this.cmptCodeColoured) {jsonObj.put("cmptCode", this.cmptCode);}
        if(this.cmptNameColoured) {jsonObj.put("cmptName", this.cmptName);}
        if(this.cmptTypeColoured) {jsonObj.put("cmptType", this.cmptType);}
        if(this.relAlgorithmIdColoured) {jsonObj.put("relAlgorithmId", this.relAlgorithmId);}
