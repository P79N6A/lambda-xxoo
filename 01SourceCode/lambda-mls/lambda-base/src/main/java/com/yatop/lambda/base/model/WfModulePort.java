...
public class WfModulePort extends LambdaRootModel implements Serializable {
    ...
    public void copyProperties(Object that) {
        ...
        WfModulePort other = (WfModulePort) that;
        if(other.isPortIdColoured() ) {this.setPortId(other.getPortId() );}
        if(other.isPortNameColoured() ) {this.setPortName(other.getPortName() );}
        if(other.isPortTypeColoured() ) {this.setPortType(other.getPortType() );}
        if(other.isOwnerModuleIdColoured() ) {this.setOwnerModuleId(other.getOwnerModuleId() );}
        if(other.isBindCharIdColoured() ) {this.setBindCharId(other.getBindCharId() );}
    ...
    public JSONObject toJSON() {
        ...
        if(this.portIdColoured) {hashMap.put("portId", this.portId);}
        if(this.portNameColoured) {hashMap.put("portName", this.portName);}
        if(this.portTypeColoured) {hashMap.put("portType", this.portType);}
        if(this.ownerModuleIdColoured) {hashMap.put("ownerModuleId", this.ownerModuleId);}
        if(this.bindCharIdColoured) {hashMap.put("bindCharId", this.bindCharId);}
    ...
    @Override
    public void clear() {
        if(this.portIdColoured) {this.portId = null; this.portIdColoured = false;}
        if(this.portNameColoured) {this.portName = null; this.portNameColoured = false;}
        if(this.portTypeColoured) {this.portType = null; this.portTypeColoured = false;}
        if(this.ownerModuleIdColoured) {this.ownerModuleId = null; this.ownerModuleIdColoured = false;}
        if(this.bindCharIdColoured) {this.bindCharId = null; this.bindCharIdColoured = false;}
