...
public class WfModuleCatalog extends LambdaRootModel implements Serializable {
    ...
    public void clear() {
        ...
        if(this.catalogCodeColoured) {this.catalogCode = null; this.catalogCodeColoured = false;}
        if(this.catalogNameColoured) {this.catalogName = null; this.catalogNameColoured = false;}
        if(this.parentCatalogIdColoured) {this.parentCatalogId = null; this.parentCatalogIdColoured = false;}
