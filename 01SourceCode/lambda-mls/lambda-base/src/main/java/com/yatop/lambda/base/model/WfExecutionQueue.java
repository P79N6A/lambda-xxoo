...
public class WfExecutionQueue extends LambdaRootModel implements Serializable {
     ...
     * @mbg.generated Sat Dec 15 15:48:44 CST 2018
     */
    public void copyProperties(WfExecutionQueue that) {
    ...
    public JSONObject toJSON() {
        ...
        if(this.jobTimeColoured) {jsonObj.put("jobTime", this.jobTime);}
        if(this.jobSignalColoured) {jsonObj.put("jobSignal", this.jobSignal);}
    ...
    public void clear() {
        ...
        if(this.jobTimeColoured) {this.jobTime = null; this.jobTimeColoured = false;}
        if(this.jobSignalColoured) {this.jobSignal = null; this.jobSignalColoured = false;}
