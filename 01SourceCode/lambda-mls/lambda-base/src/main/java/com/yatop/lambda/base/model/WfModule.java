...
public class WfModule extends LambdaRootModel implements Serializable {
    ...
    public void copyProperties(Object that) {
        ...
        if(other.isModuleCodeColoured() ) {this.setModuleCode(other.getModuleCode() );}
        if(other.isModuleNameColoured() ) {this.setModuleName(other.getModuleName() );}
        ...
        if(other.isPkgCmptIdColoured() ) {this.setPkgCmptId(other.getPkgCmptId() );}
    ...
    public JSONObject toJSON() {
        ...
        if(this.moduleCodeColoured) {hashMap.put("moduleCode", this.moduleCode);}
        if(this.moduleNameColoured) {hashMap.put("moduleName", this.moduleName);}
        ...
        if(this.pkgCmptIdColoured) {hashMap.put("pkgCmptId", this.pkgCmptId);}
    ...
    public void clear() {
        ...
        if(this.moduleCodeColoured) {this.moduleCode = null; this.moduleCodeColoured = false;}
        if(this.moduleNameColoured) {this.moduleName = null; this.moduleNameColoured = false;}
        if(this.catalogIdColoured) {this.catalogId = null; this.catalogIdColoured = false;}
        if(this.sequenceColoured) {this.sequence = null; this.sequenceColoured = false;}
        if(this.categoryColoured) {this.category = null; this.categoryColoured = false;}
        if(this.iconTypeColoured) {this.iconType = null; this.iconTypeColoured = false;}
        if(this.classPathColoured) {this.classPath = null; this.classPathColoured = false;}
        if(this.pkgCmptIdColoured) {this.pkgCmptId = null; this.pkgCmptIdColoured = false;}
