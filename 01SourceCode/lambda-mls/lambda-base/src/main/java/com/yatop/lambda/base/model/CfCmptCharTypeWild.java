...
public class CfCmptCharTypeWild extends LambdaRootModel implements Serializable {
     ...
     *
     * This field was generated by MyBatis Generator.
     * This field corresponds to the database column cf_cmpt_char_type_wild.UNIT_CHAR_TYPE_ID:Coloured
     *
     * @mbg.generated Fri Dec 07 19:33:25 CST 2018
     */
    private boolean unitCharTypeIdColoured;
    ...
    /**
     * This method was generated by MyBatis Generator.
     * This method returns the value of the database column cf_cmpt_char_type_wild.UNIT_CHAR_TYPE_ID:Coloured
     *
     * @return the value of cf_cmpt_char_type_wild.UNIT_CHAR_TYPE_ID:Coloured
     *
     * @mbg.generated Fri Dec 07 19:33:25 CST 2018
     */
    public boolean isUnitCharTypeIdColoured() {
        return unitCharTypeIdColoured;
    }
     ...
     * @mbg.generated Fri Dec 07 19:33:25 CST 2018
     */
    public boolean isUnitCharTypeIdNotColoured() {
        return !unitCharTypeIdColoured;
    }
    ...
    public void setUnitCharTypeId(Integer unitCharTypeId) {
        ...
        this.unitCharTypeIdColoured = true;
    }

    /**
     * This method was generated by MyBatis Generator.
     * This method sets the value of the database column cf_cmpt_char_type_wild.UNIT_CHAR_TYPE_ID:Coloured
     *
     * @param unitCharTypeIdColoured the value for cf_cmpt_char_type_wild.UNIT_CHAR_TYPE_ID:Coloured
     *
     * @mbg.generated Fri Dec 07 19:33:25 CST 2018
     */
    public void setUnitCharTypeIdColoured(boolean unitCharTypeIdColoured) {
        this.unitCharTypeIdColoured = unitCharTypeIdColoured;
    }
    ...
    public void copyProperties(Object that) {
        ...
        CfCmptCharTypeWild other = (CfCmptCharTypeWild) that;
        if(other.isWildCharTypeIdColoured() ) {this.setWildCharTypeId(other.getWildCharTypeId() );}
        if(other.isUnitCharTypeIdColoured() ) {this.setUnitCharTypeId(other.getUnitCharTypeId() );}
    ...
    public JSONObject toJSON() {
        ...
        if(this.wildCharTypeIdColoured) {hashMap.put("wildCharTypeId", this.wildCharTypeId);}
        if(this.unitCharTypeIdColoured) {hashMap.put("unitCharTypeId", this.unitCharTypeId);}
    ...
    @Override
    public void clear() {
        if(this.wildCharTypeIdColoured) {this.wildCharTypeId = null; this.wildCharTypeIdColoured = false;}
        if(this.unitCharTypeIdColoured) {this.unitCharTypeId = null; this.unitCharTypeIdColoured = false;}
