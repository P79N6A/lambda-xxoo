...
public class CfCmptCharTypeWild extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.matchCharTypeIdColoured) {hashMap.put("matchCharTypeId", this.matchCharTypeId);}
    ...
    public void clear() {
        ...
        if(this.matchCharTypeIdColoured) {this.matchCharTypeId = null; this.matchCharTypeIdColoured = false;}
