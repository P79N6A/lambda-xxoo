...
public class CfCmptCharTypeWild extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.wildCharTypeId != null) {jsonObj.put("wildCharTypeId", this.wildCharTypeId);}
        if(this.matchCharTypeId != null) {jsonObj.put("matchCharTypeId", this.matchCharTypeId);}
    ...
    public void clearColoured() {
        this.wildCharTypeIdColoured = false;
        this.matchCharTypeIdColoured = false;
    ...
    public boolean isColoured() {
        if(this.wildCharTypeIdColoured) return true;
        if(this.matchCharTypeIdColoured) return true;
