...
public class WfFlowNodeParameter extends LambdaRootModel implements Serializable {
    ...
    public void copyProperties(Object that) {
        ...
        if(other.isLastGlobalParameterIdColoured() ) {this.setLastGlobalParameterId(other.getLastGlobalParameterId() );}
    ...
    public JSONObject toJSON() {
        ...
        if(this.lastGlobalParameterIdColoured) {hashMap.put("lastGlobalParameterId", this.lastGlobalParameterId);}
    ...
    public void clear() {
        ...
        if(this.lastGlobalParameterIdColoured) {this.lastGlobalParameterId = null; this.lastGlobalParameterIdColoured = false;}
