...
public class PrProjectMember extends LambdaRootModel implements Serializable {
    ...
    public void copyProperties(Object that) {
        ...
        if(other.isProjectRoleColoured() ) {this.setProjectRole(other.getProjectRole() );}
    ...
    public JSONObject toJSON() {
        ...
        if(this.projectRoleColoured) {hashMap.put("projectRole", this.projectRole);}
    ...
    public void clear() {
        ...
        if(this.projectRoleColoured) {this.projectRole = null; this.projectRoleColoured = false;}
