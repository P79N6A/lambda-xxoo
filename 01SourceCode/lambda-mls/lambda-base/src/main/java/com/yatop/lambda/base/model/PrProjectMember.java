...
public class PrProjectMember extends LambdaRootModel implements Serializable {
     ...
     * @mbg.generated Thu Feb 28 16:41:10 CST 2019
     */
    public PrProjectMember makeCopy() {
        PrProjectMember copy = new PrProjectMember();
        if(this.projectId != null ) {copy.projectId = this.projectId;}
        if(this.projectRole != null ) {copy.projectRole = this.projectRole;}
        if(this.memberUser != null ) {copy.memberUser = this.memberUser;}
