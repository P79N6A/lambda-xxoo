...
public class WfFlowNodeLink extends LambdaRootModel implements Serializable {
     ...
     * @mbg.generated Thu Feb 28 16:41:10 CST 2019
     */
    public WfFlowNodeLink makeCopy() {
        WfFlowNodeLink copy = new WfFlowNodeLink();
        if(this.linkId != null ) {copy.linkId = this.linkId;}
        if(this.linkName != null ) {copy.linkName = this.linkName;}
        if(this.ownerFlowId != null ) {copy.ownerFlowId = this.ownerFlowId;}
        if(this.srcNodeId != null ) {copy.srcNodeId = this.srcNodeId;}
        if(this.srcPortId != null ) {copy.srcPortId = this.srcPortId;}
        if(this.dstNodeId != null ) {copy.dstNodeId = this.dstNodeId;}
        if(this.dstPortId != null ) {copy.dstPortId = this.dstPortId;}
