...
public class WfFlowNodeLink extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.linkIdColoured) {jsonObj.put("linkId", this.linkId);}
        if(this.linkNameColoured) {jsonObj.put("linkName", this.linkName);}
        if(this.ownerFlowIdColoured) {jsonObj.put("ownerFlowId", this.ownerFlowId);}
        if(this.isWebLinkColoured) {jsonObj.put("isWebLink", this.isWebLink);}
        if(this.srcPortIdColoured) {jsonObj.put("srcPortId", this.srcPortId);}
        if(this.dstPortIdColoured) {jsonObj.put("dstPortId", this.dstPortId);}
    ...
    public void clear() {
        ...
        if(this.linkNameColoured) {this.linkName = null; this.linkNameColoured = false;}
