...
public class WfFlowNodePort extends LambdaRootModel implements Serializable {
    ...
    public void copyProperties(Object that) {
        ...
        if(other.isNodePortNameColoured() ) {this.setNodePortName(other.getNodePortName() );}
    ...
    public JSONObject toJSON() {
        ...
        if(this.nodePortNameColoured) {hashMap.put("nodePortName", this.nodePortName);}
    ...
    public void clear() {
        ...
        if(this.nodePortNameColoured) {this.nodePortName = null; this.nodePortNameColoured = false;}
