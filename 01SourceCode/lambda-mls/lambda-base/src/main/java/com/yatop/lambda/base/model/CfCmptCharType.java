...
public class CfCmptCharType extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.charTypeIdColoured) {jsonObj.put("charTypeId", this.charTypeId);}
        if(this.charTypeCodeColoured) {jsonObj.put("charTypeCode", this.charTypeCode);}
        if(this.charTypeNameColoured) {jsonObj.put("charTypeName", this.charTypeName);}
        if(this.isWildtypeColoured) {jsonObj.put("isWildtype", this.isWildtype);}
        if(this.specMaskColoured) {jsonObj.put("specMask", this.specMask);}
    ...
    public void clear() {
        ...
        if(this.specMaskColoured) {this.specMask = null; this.specMaskColoured = false;}
