...
public class CfCmptCharEnum extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.enumNameColoured) {jsonObj.put("enumName", this.enumName);}
        if(this.enumValueColoured) {jsonObj.put("enumValue", this.enumValue);}
        if(this.enumLabelColoured) {jsonObj.put("enumLabel", this.enumLabel);}
