...
public class SysParameter extends LambdaRootModel implements Serializable {
     ...
     * @mbg.generated Thu Feb 28 16:41:10 CST 2019
     */
    public SysParameter makeCopy() {
        SysParameter copy = new SysParameter();
        if(this.paramId != null ) {copy.paramId = this.paramId;}
        if(this.paramCode != null ) {copy.paramCode = this.paramCode;}
        if(this.paramName != null ) {copy.paramName = this.paramName;}
        if(this.paramClass != null ) {copy.paramClass = this.paramClass;}
        if(this.paramSubClass != null ) {copy.paramSubClass = this.paramSubClass;}
        if(this.paramValue != null ) {copy.paramValue = this.paramValue;}
