...
public class DwDataWarehouse extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.dwIdColoured) {jsonObj.put("dwId", this.dwId);}
        if(this.dwCodeColoured) {jsonObj.put("dwCode", this.dwCode);}
        if(this.dwNameColoured) {jsonObj.put("dwName", this.dwName);}
        if(this.dwTypeColoured) {jsonObj.put("dwType", this.dwType);}
        if(this.ownerProjectIdColoured) {jsonObj.put("ownerProjectId", this.ownerProjectId);}
        if(this.dataDfsDirColoured) {jsonObj.put("dataDfsDir", this.dataDfsDir);}
        if(this.dataLocalDirColoured) {jsonObj.put("dataLocalDir", this.dataLocalDir);}
