...
public class DwDataWarehouse extends LambdaRootModel implements Serializable {
     ...
     * @mbg.generated Thu Feb 28 16:41:10 CST 2019
     */
    public DwDataWarehouse makeCopy() {
        DwDataWarehouse copy = new DwDataWarehouse();
        if(this.dwId != null ) {copy.dwId = this.dwId;}
        if(this.dwCode != null ) {copy.dwCode = this.dwCode;}
        if(this.dwName != null ) {copy.dwName = this.dwName;}
        if(this.dwType != null ) {copy.dwType = this.dwType;}
        if(this.ownerProjectId != null ) {copy.ownerProjectId = this.ownerProjectId;}
        if(this.dataDfsDir != null ) {copy.dataDfsDir = this.dataDfsDir;}
        if(this.dataLocalDir != null ) {copy.dataLocalDir = this.dataLocalDir;}
