...
public class WfFlowGlobalParameter extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.globalParamIdColoured) {jsonObj.put("globalParamId", this.globalParamId);}
        if(this.globalParamNameColoured) {jsonObj.put("globalParamName", this.globalParamName);}
