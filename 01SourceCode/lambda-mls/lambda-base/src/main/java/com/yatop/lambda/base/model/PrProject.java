...
public class PrProject extends LambdaRootModel implements Serializable {
     ...
     * @mbg.generated Thu Feb 28 16:41:10 CST 2019
     */
    public PrProject makeCopy() {
        PrProject copy = new PrProject();
        if(this.projectId != null ) {copy.projectId = this.projectId;}
        if(this.projectCode != null ) {copy.projectCode = this.projectCode;}
        if(this.projectName != null ) {copy.projectName = this.projectName;}
        if(this.dwId != null ) {copy.dwId = this.dwId;}
        if(this.mwId != null ) {copy.mwId = this.mwId;}
        if(this.cacheExpireDays != null ) {copy.cacheExpireDays = this.cacheExpireDays;}
