...
public class PrProject extends LambdaRootModel implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        if(this.projectCodeColoured) {jsonObj.put("projectCode", this.projectCode);}
        if(this.projectNameColoured) {jsonObj.put("projectName", this.projectName);}
        if(this.dwIdColoured) {jsonObj.put("dwId", this.dwId);}
        if(this.mwIdColoured) {jsonObj.put("mwId", this.mwId);}
        if(this.cacheExpireDaysColoured) {jsonObj.put("cacheExpireDays", this.cacheExpireDays);}
