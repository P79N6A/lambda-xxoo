...
public class ClazzHelperUtil {
    ...
    public static ICharTypeClazz getCharTypeClazzBean(CmptCharType cmptCharType) {
        ICharTypeClazz charTypeClazz = CharTyeClazzBaseClazz.getClazzBean(cmptCharType.data().getClassPath());
    ...
    public static IModuleClazz getModuleClazzBean(Module module) {
        IModuleClazz moduleClazz = ModuleClazzClazzBase.getClazzBean(module.data().getClassPath());
