...
public class ExperimentService {
    ...
    public EmExperiment createExperiment(ExperimentRequest vo) {
        ...
        EmExperiment result = experimentMgr.insertExperiment(emExperiment, PortalUtil.getCurrentUser().getUsername());
        editorService.createWorkflow(result,PortalUtil.getCurrentUser().getUsername());
        return result;
    }
